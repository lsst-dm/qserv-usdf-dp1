...
VERBOSE_OPT="--verbose"
DEBUG_OPT=
DIRECTOR_TABLES="allwise_p3as_psd"
DEPENDENT_TABLES="allwise_p3as_mep"
PARTITIONED_TABLES="allwise_p3as_psd allwise_p3as_mep"
FULLY_REPLICATED_TABLES=
ALL_TABLES="${PARTITIONED_TABLES} ${FULLY_REPLICATED_TABLES}"

# CSV dialect definitions for the tables
allwise_p3as_psd_CSV_DIALECT='--fields-enclosed-by="'
allwise_p3as_mep_CSV_DIALECT='--fields-enclosed-by="'
