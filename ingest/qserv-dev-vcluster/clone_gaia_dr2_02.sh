...
VERBOSE_OPT="--verbose"
DEBUG_OPT=
DIRECTOR_TABLES="gaia_source"
DEPENDENT_TABLES=
PARTITIONED_TABLES="gaia_source"
FULLY_REPLICATED_TABLES="aux_allwise_agn_gdr2_cross_id aux_iers_gdr2_cross_id aux_sso_orbit_residuals aux_sso_orbits light_curves sso_observation sso_source vari_cepheid vari_classifier_result vari_long_period_variable vari_rotation_modulation vari_rrlyrae vari_short_timescale vari_time_series_statistics"
ALL_TABLES="${PARTITIONED_TABLES} ${FULLY_REPLICATED_TABLES}"

# CSV dialect definitions for the tables
gaia_source_CSV_DIALECT='--fields-enclosed-by="'
aux_allwise_agn_gdr2_cross_id_CSV_DIALECT='--fields-enclosed-by="'
aux_iers_gdr2_cross_id_CSV_DIALECT='--fields-enclosed-by="'
aux_sso_orbit_residuals_CSV_DIALECT=
aux_sso_orbits_CSV_DIALECT='--fields-enclosed-by="'
light_curves_CSV_DIALECT='--fields-enclosed-by="'
sso_observation_CSV_DIALECT=
sso_source_CSV_DIALECT='--fields-enclosed-by="'
vari_cepheid_CSV_DIALECT='--fields-enclosed-by="'
vari_classifier_result_CSV_DIALECT='--fields-enclosed-by="'
vari_long_period_variable_CSV_DIALECT=
vari_rotation_modulation_CSV_DIALECT='--fields-enclosed-by="'
vari_rrlyrae_CSV_DIALECT='--fields-enclosed-by="'
vari_short_timescale_CSV_DIALECT='--fields-enclosed-by="'
vari_time_series_statistics_CSV_DIALECT=
